    ...
    return (
        <>
            <div className="form-container card border-0 shadow rounded-3 my-5 p-5">
                ...
                <div className="form-group">
                    <label htmlFor="name">Other Payments</label>
                </div>
                <div className="form-group">
                    <label htmlFor="name">PSO Card</label>
                    <input type="number" id="name" name="name" required value={psoCard} onChange={(e) => setPsoCard(e.target.value)}/>
                </div>
                <div className="form-group">
                    <label htmlFor="name">HBL Card</label>
                    <input type="number" id="name" name="name" required value={HBLCard} onChange={(e) => setHBLCard(e.target.value)}/>
                </div>
                <div className="form-group">
                    <label htmlFor="name">BANK Deposit</label>
                    <input type="number" id="name" name="name" required value={bankDeposit} onChange={(e) => setBankDeposit(e.target.value)}/>
                </div>
            </div>
...
export default EditAliPetrolium