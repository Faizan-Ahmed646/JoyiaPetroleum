...
const AddBhattiPetrolium = () => {
    ...
    const saveData = async (e) => {
        ...
        e.preventDefault();
        let pumpData = await fetch("https://backend.joyiapetroleum.com/joiya/bhattiPetrolium/data/", {
            method: 'POST',
            body: JSON.stringify({
    ...
    const userData = async () => {
        let res = await fetch("https://backend.joyiapetroleum.com/joiya/bhattiPetrolium/data")
        res = await res.json();
...
export default AddBhattiPetrolium
