...
const GetSingleBhattiPetroliumData = () => {
...
const pumpData = async() =>{
    let res = await fetch(`https://backend.joyiapetroleum.com/joiya/bhattiPetrolium/data/${id}`)
    res = await res.json();    
...
export default GetSingleBhattiPetroliumData
