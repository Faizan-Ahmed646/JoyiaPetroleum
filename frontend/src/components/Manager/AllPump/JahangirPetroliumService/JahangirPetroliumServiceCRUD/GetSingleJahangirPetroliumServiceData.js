...
const GetSingleJahangirPetroliumServiceData = () => {
...
/joiya/jahangirPetrolium/data/${id}`)
 ...
 const generatePDF= useReactToPrint({
    ...
    documentTitle: "JahangirPetrolium",
  ...
  return (
    ...
    <div>
        ...
        <div className='headcss_2'>
            <p>Station: Jahangir Petrolium Service</p>
...
export default GetSingleJahangirPetroliumServiceData
