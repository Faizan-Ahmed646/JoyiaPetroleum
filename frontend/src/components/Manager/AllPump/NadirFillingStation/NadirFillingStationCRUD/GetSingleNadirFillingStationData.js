...
const GetSingleNadirFillingStationData = () => {
...
const pumpData = async() =>{
 ...
 const generatePDF= useReactToPrint({
    ...
    documentTitle: "NadirFillingStations",
  ...
  return (
    ...
    <div>
        ...
        <div className='headcss_2'>
            <p>Station: Nadir Filling Station</p>
...
export default GetSingleNadirFillingStationData
