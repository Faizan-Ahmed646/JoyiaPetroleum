...
const AddIDFillingStation = () => {
    ...
    const saveData = async (e) => {
        ...
        e.preventDefault();
        let pumpData = await fetch("https://backend.joyiapetroleum.com/joiya/idFillingStation/data/", {
            method: 'POST',
            body: JSON.stringify({
    ...
    const userData = async () => {
        let res = await fetch("https://backend.joyiapetroleum.com/joiya/idFillingStation/data")
        res = await res.json();
...
export default AddIDFillingStation
