...
const GetSingleAlSiddiqueFillingStationData = () => {
...
const pumpData = async() =>{
 ...
 const generatePDF= useReactToPrint({
    ...
    documentTitle: "AlSiddiquePetrolium",
  ...
  return (
    ...
    <div>
        ...
        <div className='headcss_2'>
            <p>Station: Al Siddique Filling Station</p>
...
export default GetSingleAlSiddiqueFillingStationData
