...
/joiya/awanbrothers/data/${params.id}`)
        ...
        setLastReadingHsd3(res.lastReadingHsd3)
        setLastReadingHsd4(res.lastReadingHsd4)
        setLastReadingHsd5(res.lastReadingHsd5)
        setLastReadingHsd6(res.lastReadingHsd6)
        ...
        setHsd3CurrentReading(res.hsd3_currentReading)
        setHsd4CurrentReading(res.hsd4_currentReading)
        setHsd5CurrentReading(res.hsd5_currentReading)
        setHsd6CurrentReading(res.hsd6_currentReading)
            ...
            <div className="form-container card border-0 shadow rounded-3 my-5 p-5">
                ...
                <form>
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            <label htmlFor="name">Current Reading</label>
                            <input type="number" id="name" name="name" required value={hsd3_currentReading} onChange={(e) => setHsd3CurrentReading(e.target.value)} />
                        </div>
                    </div>
                    {/* HSD 4 */}
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            <label htmlFor="name">Current Reading</label>
                            <input type="number" id="name" name="name" required value={hsd4_currentReading} onChange={(e) => setHsd4CurrentReading(e.target.value)} />
                        </div>
                    </div>
                    {/* HSD 5 */}
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            <label htmlFor="name">Current Reading</label>
                            <input type="number" id="name" name="name" required value={hsd5_currentReading} onChange={(e) => setHsd5CurrentReading(e.target.value)} />
                        </div>
                    </div>
                    {/* HSD 6 */}
                    <div className="form-row">
                        ...
                        <div className="form-group">
                            <label htmlFor="name">Current Reading</label>
                            <input type="number" id="name" name="name" required value={hsd6_currentReading} onChange={(e) => setHsd6CurrentReading(e.target.value)} />
                        </div>
                    </div>
...
export default EditAwanBrother