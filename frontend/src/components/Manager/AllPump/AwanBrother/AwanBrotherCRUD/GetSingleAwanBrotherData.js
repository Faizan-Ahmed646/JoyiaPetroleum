...
const GetSingleAwanBrotherData = () => {
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td >HSD</td>
          <td >HSD5=COM</td>
          <td >{aliPetroliumPump.lastReadingHsd5}</td>
          <td >{aliPetroliumPump.hsd5_currentReading}</td>
          <td >{aliPetroliumPump.comSalehsd5}</td>
        </tr>
        <tr>
          <td>8</td>
          <td >HSD</td>
          <td >HSD6=COM</td>
          <td >{aliPetroliumPump.lastReadingHsd6}</td>
          <td >{aliPetroliumPump.hsd6_currentReading}</td>
          <td >{aliPetroliumPump.comSalehsd6}</td>
        </tr>
...
export default GetSingleAwanBrotherData
