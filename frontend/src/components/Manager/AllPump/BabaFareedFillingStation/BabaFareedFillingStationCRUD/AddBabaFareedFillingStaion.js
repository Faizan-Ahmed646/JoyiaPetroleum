...
const AddBabaFareedFillingStaion = () => {
    // get last reading 
    ...
    const saveData = async (e) => {
        ...
        setData(pumpData);
        navigate('/baba-fareed-filling-station/get-all-data')
    ...
    const userData = async () => {
        let res = await fetch("https://backend.joyiapetroleum.com/joiya/babafareed/data")
        res = await res.json();
    ...
    return (
        <>
            <div className="form-container card border-0 shadow rounded-3 my-5 p-5">
                <h1 className="mb-5">Baba Fareed Filling Staion</h1>
                <hr />
                <form>
...
export default AddBabaFareedFillingStaion
