...
const GetSingleBabaFareedFillingStaionData = () => {
...
const pumpData = async() =>{
 ...
 const generatePDF= useReactToPrint({
    ...
    documentTitle: "BabaFareedFillingStation",
  ...
  return (
    ...
    <div>
        ...
        <div className='headcss_2'>
            <p>Station: Baba Fareed Filling Staion</p>
...
export default GetSingleBabaFareedFillingStaionData
