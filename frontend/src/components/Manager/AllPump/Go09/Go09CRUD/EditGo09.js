...
const EditGo09 = () => {
    ...
    const getUserDetail = async () => {
        let res = await fetch(`https://backend.joyiapetroleum.com/joiya/go09/data/${params.id}`)
        res = await res.json();
